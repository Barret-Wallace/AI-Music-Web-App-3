...
function gotPoses(result){
    if(result.length > 0){
        console.log(result);
        leftWristx = result[0].posel.leftWrist.x;
        leftWristy = result[0].posel.leftWrist.y;

        rightWristx = result[0].posel.rightWrist.x;
        rightWristy = result[0].posel.rightWrist.y;
    }
}
